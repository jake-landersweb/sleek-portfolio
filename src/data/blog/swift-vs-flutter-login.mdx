---
title: Swift vs Flutter - LoginUI
description: I built the same screen in both Flutter and SwiftUI to compare and contrast them against each other
image: '/blog/swift-vs-flutter-login.png'
